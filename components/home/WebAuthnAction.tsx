...
export function WebAuthnAction() {
  ...
  return (
    <button
      ...
      className="group relative flex items-center gap-4 rounded-2xl p-4 text-left md:p-6 active:scale-[0.99] border border-zinc-500/30 hover:border-zinc-500/80  cursor-pointer"
      role="menuitem"
