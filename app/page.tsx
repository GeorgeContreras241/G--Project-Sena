...
export default function Home() {
  return (
    <main className="fondo flex flex-col h-dvh items-center justify-around  md:justify-center md:gap-20 font-sans dark:bg-background px-2">
      <section className="w-full flex flex-col gap-4 sm:w-3/4 md:w-2/4 lg:w-2/7 h-fit  p-8 border rounded-2xl border-border bg-bg-card">
        <div className="p-4"> 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 justify-center items-center gap-4 h-fit">
          <Link href="/offline" className="flex flex-row sm:flex-col  items-center justify-start md:justify-center gap-2 md:gap-6  text-center
          w-full sm:h-50 py-3 px-4 border rounded-2xl border-border-subtle cursor-pointer bg-bg-overlay hover:bg-bg-elevated transition-colors group">
            <div className="group-hover:scale-[1.05] h-10 sm:h-14 md:h-16 lg:h-18 transition-all duration-100">
              <Archive />
            </div>
            <div>
          ...
          <button  className="flex flex-row sm:flex-col  items-center justify-start md:justify-center gap-2 md:gap-6 
          w-full sm:h-50 py-3 px-4 border rounded-2xl border-border-subtle cursor-pointer bg-bg-overlay hover:bg-bg-elevated transition-colors group">
