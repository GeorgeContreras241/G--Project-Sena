...
export const PasswordCard = ({ 
  ...
  return (
    <article className="bg-white/95 dark:bg-blue-950 backdrop-blur-md border border-gray-300 dark:border-blue-950/20 rounded-lg overflow-hidden hover:border-blue-400 dark:hover:border-blue-900/40 transition-all duration-300 hover:scale-[1.003] shadow-sm hover:shadow-md">
